...
begin
  ...
  if (v_exists_in_table = 'N') then
    insert into constructor_standings (race_id, constructor_id, points, position, position_type, win_amount)
      values (p_race_id, v_constructor_id, p_points, p_position, p_position_type, p_amount_of_wins);
  end if;
end;