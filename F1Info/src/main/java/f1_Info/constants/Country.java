...
public enum Country{
    ...
    SAUDI_ARABIA("sa", List.of("saudiarabia"), emptyList()),
    ...
    SOUTH_AFRICA("za", List.of("southafrica"), List.of("south african")),
    ...
    UNITED_STATES("us", List.of("usa", "unitedstates"), List.of("american")),
